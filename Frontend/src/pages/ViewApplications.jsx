          ...
          {viewApplicationsPageData.map((applicant,index)=>(
            <tr key={index} className='text-gray-700'>
              ...
              <td  className='py-2 px-4 border-b border-gray-300 text-center flex'>
                <img className='w-10 h-12 rounded-full mr-3 max-sm:hidden' src={applicant.imgSrc} alt=""/>
                <span className='text-center'>{applicant.name}</span>
              </td>
              <td className='py-2 px-4 border-b border-gray-300 max-sm:hidden'>{applicant.jobTitle}</td>
